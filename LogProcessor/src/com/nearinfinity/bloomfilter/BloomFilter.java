...
public class BloomFilter<T> extends BloomFilterFormulas implements Serializable {
	...
	public BloomFilterBitSet bitSet;
	...
	public BloomFilter cloneCo() 
	{
		
		//return super.clone();
		
		BloomFilter bloomFilterCloned = null;
		
		bloomFilterCloned.bitSet=this.bitSet.cloneCo();
		bloomFilterCloned.hashes=this.hashes;
		bloomFilterCloned.numberOfBitsDivBy2=this.numberOfBitsDivBy2;
		bloomFilterCloned.toBytes=this.toBytes;
		//bloomFilterCloned=(BloomFilter) this.clone();
		return bloomFilterCloned;
