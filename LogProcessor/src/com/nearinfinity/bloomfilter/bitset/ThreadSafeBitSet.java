...
public class ThreadSafeBitSet extends BloomFilterBitSet implements Cloneable, Serializable {
	...
	public ThreadSafeBitSet cloneCo()
	{
		ThreadSafeBitSet toCopy= null;
		/*
		try {
			toCopy=(ThreadSafeBitSet) this.clone();
		} catch (CloneNotSupportedException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		*/
		toCopy.bits=this.bits;
		//toCopy.serialVersionUID=this.serialVersionUID;
