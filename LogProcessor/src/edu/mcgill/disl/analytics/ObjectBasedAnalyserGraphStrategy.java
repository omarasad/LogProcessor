...
public abstract class ObjectBasedAnalyserGraphStrategy {
	
	public ObjectBasedAnalyserGraph analyser;
	public LoadBalancerPolicy oldLB; 
	// for convenience
	public StatisticsManager manager;
	
	public ObjectBasedAnalyserGraphStrategy(ObjectBasedAnalyserGraph analyser){
