...
public abstract class RequestBasedAnalyserGraphStrategy {
	
	public RequestBasedAnalyserGraph analyser;
	...
	public RequestBasedAnalyserGraphStrategy(RequestBasedAnalyserGraph analyser){
