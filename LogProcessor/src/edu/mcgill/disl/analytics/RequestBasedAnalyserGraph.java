...
public class RequestBasedAnalyserGraph extends Analyser {
	...
	RequestBasedAnalyserGraphStrategy strategy = null;
...
//	public final String  partionerOld="/home/db/dislcluster/thesis/jboss-5.1.0.GA/server/minimal/graphPartitoner/khmetis";
	...
	public RequestBasedAnalyserGraph(StatisticsManager manager) {
		super(manager);
		setupStrategy();
	...
	public void setupStrategy(){
		...
		strategy = (RequestBasedAnalyserGraphStrategy) c.getConstructor(new Class[] { RequestBasedAnalyserGraph.class }).newInstance(this);
