...
import edu.mcgill.disl.analytics.Bag;
import edu.mcgill.disl.analytics.Edge;
import edu.mcgill.disl.analytics.In;

import edu.mcgill.disl.analytics.StdIn;
import edu.mcgill.disl.analytics.StdOut;;
...
public class EdgeWeightedGraph {
   ...
   /**
    ...
    public static void main(String[] args) {
        In in = new In(" http://algs4.cs.princeton.edu/43mst/tinyEWG.txt");
